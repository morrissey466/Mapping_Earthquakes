...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  majorLink = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
  d3.json(majorLink).then(function (data) {
    ...
    function styleInfo(feature) {
      return {
        opacity: 1,
        fillOpacity: 1,
        fillColor: getColorbig(feature.properties.mag),
        color: "#000000",
    ...
    function getColorbig(magnitude) {
      if (magnitude > 5) {
        return "#ea2c2c";
      }
      if (magnitude < 4) {
